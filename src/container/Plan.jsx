export const Plan = () => {
  return (
    <div className="mb-[114px]">
      ...
      <div className="bg-[rgb(25,26,35)] rounded-[45px] h-auto   text-white">
        <div className="flex flex-row justify-center align-middle py-[42px] font-normal text-[24px]">
          <div className=" px-[60px] border-r-[1px]">
